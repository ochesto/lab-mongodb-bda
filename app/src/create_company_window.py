...
class Ui_create_company_window(object):
    def setupUi(self, create_company_window):
        ...
        self.window = create_company_window
        ...
        self.pushButton_cancel.clicked.connect( create_company_window.close )
    ...
    def submit(self):
        res = create_company(
            ...
            self.lineEdit__fundation_year.text(),
            self.lineEdit__web_address.text()
        )
        self.showdialog( res )
