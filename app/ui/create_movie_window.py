...
# Form implementation generated from reading ui file 'create_movie_window.ui'
#
...
if __name__ == "__main__":
    ...
    create_movie_window = QtWidgets.QMainWindow()
    ui = Ui_create_movie_window()
    ui.setupUi(create_movie_window)
    create_movie_window.show()
    sys.exit(app.exec_())
